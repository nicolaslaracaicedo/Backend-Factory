...
interface DetalleRecurrenteAttributes {
  id: number;
...
export class DetalleRecurrente extends Model<DetalleRecurrenteAttributes> implements DetalleRecurrenteAttributes {
  declare id: number;
  declare id_recurrente: number;
...
DetalleRecurrente.init(
  {
    id:              { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    id_recurrente:   { type: DataTypes.INTEGER, allowNull: false },
  ...
  { sequelize, tableName: 'detalle_recurrentes' }
);
