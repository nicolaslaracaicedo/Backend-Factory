...
interface NotaDebitoAttributes {
  id: number;
  id_empresa: number;
  id_usuario: number;
...
export class NotaDebito extends Model<NotaDebitoAttributes> implements NotaDebitoAttributes {
  declare id: number;
...
NotaDebito.init(
  ...
  { sequelize, tableName: 'notas_debito' }
);
