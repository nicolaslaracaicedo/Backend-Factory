...
interface DetalleNotaCreditoAttributes {
  id: number;
...
export class DetalleNotaCredito extends Model<DetalleNotaCreditoAttributes> implements DetalleNotaCreditoAttributes {
  declare id: number;
  declare id_nota_credito: number;
...
DetalleNotaCredito.init(
  {
    ...
    id_nota_credito: { type: DataTypes.INTEGER, allowNull: false },
  ...
  { sequelize, tableName: 'detalle_notas_credito' }
);
